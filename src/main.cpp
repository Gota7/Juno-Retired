...
int main()
{
    ...
    game->LoadLevelScenario("TestMap", 1);
    //game->particleMgr->AddSystemGravity("GravityTest", std::make_unique<RGravityDisk>(*static_cast<RGravityDisk*>(game->scenario->gravMgr.gravities[0].get())));
